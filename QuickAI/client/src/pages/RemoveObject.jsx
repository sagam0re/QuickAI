    ...
    return (
         <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
            ...
            <form className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'
                ...
                className='w-full p-2 px-3 mt-2 outline-none text-sm border border-gray-300 rounded-md text-gray-600' required /> 

                <p className='mt-6 text-sm font-medium'>Describe object name to remove</p>

                <textarea onChange={(e) => setObject(e.target.value)} value={object} rows={4} className='w-full p-2 px-3 mt-2 outline-none text-sm border border-gray-300 rounded-md' 
